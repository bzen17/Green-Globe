...
const authorizer = async (req, res, next) => {
  try {
    if (req.headers['authorization']) {
      ...
      return errorHandler.throwUnauthorizedError(`Error: ${JSON.stringify('NO token provided access denied')}`, req, res);
    }
  } catch (e) { 
    console.log(e);
    return errorHandler.errorHandler.throwInternalServerError('Internal Server Error!', req, res);
  }
};
